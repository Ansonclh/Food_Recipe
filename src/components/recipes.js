    ...
    <View style={styles.container}>
      <View testID="recipesDisplay">
          <FlatList
            ...
            keyExtractor={foods => foods.idFood} // Use category ID as key
            numColumns={2} 
            />
      </View>
    </View>
    ...
    >
      ...
      >
        ...
        <Text style={styles.articleDescription}>
          {item.cookingDescription.length > 40 ? item.cookingDescription.substring(0, 40) + "..." : item.cookingDescription}
        </Text>
      </TouchableOpacity>
    </View>
  );
